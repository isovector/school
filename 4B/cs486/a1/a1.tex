...
defined aspect of humanity, for example ``love'' or ``do something really new''. Turing refutes this by alluding to the
fact that these things are black boxes, and that we humans only won't assign the ability of machines to do so because we
